...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
   ...
   {
   case 0:
      cell.textLabel.text = [[NSString alloc] initWithFormat:@"First Program"];
      break;
   case 1:
      cell.textLabel.text = [[NSString alloc] initWithFormat:@"Second Program"];
      break;
   case 2:
      cell.textLabel.text = [[NSString alloc] initWithFormat:@"Third Program"];
      break;
   }
